...
export const RARITY_POUCH_IMPACT: Readonly<Record<StandardRarity | 'secret', PouchImpactProfile>> = {
  common: {
    vignettePulses: 0, vignetteAlpha: 0, pulseHalfMs: 160, pulseGapMs: 0,
    recoilScale: 0.98, recoilY: 5, recoilMs: 65,
    reboundScale: 1.012, reboundY: -2, reboundMs: 84, settleMs: 68,
    joltX: 0.8, jolts: 1,
    crackDurationMs: 160, crackStrength: 0.48, fallingFragments: 6, lateralSparks: 0,
  },
  rare: {
    vignettePulses: 1, vignetteAlpha: 0.11, pulseHalfMs: 180, pulseGapMs: 0,
    recoilScale: 0.969, recoilY: 7, recoilMs: 79,
    reboundScale: 1.022, reboundY: -3, reboundMs: 94, settleMs: 80,
    joltX: 1.5, jolts: 1,
    crackDurationMs: 220, crackStrength: 0.70, fallingFragments: 16, lateralSparks: 0,
  },
  epic: {
    vignettePulses: 1, vignetteAlpha: 0.15, pulseHalfMs: 190, pulseGapMs: 0,
    recoilScale: 0.953, recoilY: 10, recoilMs: 94,
    reboundScale: 1.032, reboundY: -5, reboundMs: 108, settleMs: 88,
    joltX: 2.6, jolts: 2,
    crackDurationMs: 270, crackStrength: 0.89, fallingFragments: 20, lateralSparks: 8,
  },
  legendary: {
    vignettePulses: 1, vignetteAlpha: 0.19, pulseHalfMs: 200, pulseGapMs: 0,
    recoilScale: 0.935, recoilY: 14, recoilMs: 112,
    reboundScale: 1.043, reboundY: -7, reboundMs: 126, settleMs: 102,
    joltX: 3.8, jolts: 2,
    crackDurationMs: 320, crackStrength: 1, fallingFragments: 25, lateralSparks: 17,
  },
  ...
  secret: {
    vignettePulses: 1, vignetteAlpha: 0.22, pulseHalfMs: 220, pulseGapMs: 0,
