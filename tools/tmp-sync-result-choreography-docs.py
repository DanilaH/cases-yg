...
# GAMEPLAY_SYSTEMS.md — lock the post-PR65 presentation contract.
replace(
...
# DECISIONS.md — remove stale stage/save/Secret wording and record PR65.
replace(
    "docs/DECISIONS.md",
...
# IMPLEMENTATION_ROADMAP.md — record the post-Secret presentation batch.
replace(
...
# YANDEX_SLICE_VALIDATION.md — carry the accepted local choreography into hosted checks.
replace(
