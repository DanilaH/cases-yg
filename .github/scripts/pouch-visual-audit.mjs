...
const startX = 640 - 126;
const startY = 326 - 101;
...
await page.mouse.move(startX + 146, startY, { steps: 8 });
await page.waitForTimeout(260);
await shot('03-drag-60');
await page.mouse.move(startX + 214, startY, { steps: 8 });
await page.waitForTimeout(260);
await shot('04-drag-88');
await page.mouse.move(startX + 254, startY, { steps: 6 });
await page.mouse.up();
